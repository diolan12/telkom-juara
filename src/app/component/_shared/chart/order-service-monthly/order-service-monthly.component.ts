...
@Component({
  selector: 'app-order-service-monthly',
  templateUrl: './order-service-monthly.component.html',
  styleUrls: ['./order-service-monthly.component.css']
})
export class OrderServiceMonthlyComponent implements AfterViewInit {
  today: Date;
  isLoading = true
